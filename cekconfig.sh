...
echo -e "Host: 81/SL-Maxstream.ehi" | lolcat
echo -e "=============================" | lolcat
echo -e "  Config HI Whatsapp/Kemdibud (Tsel)" | lolcat
echo -e "Host: 81/SL-Wa-Kemdikbud.ehi" | lolcat
echo -e "=============================" | lolcat
echo -e "  Config HI Youtube (Tsel)" | lolcat
echo -e "Host: 81/SL-YoutubeTsel.ehi" | lolcat
echo -e "=============================" | lolcat
echo -e "  Config OpenVPN TCP 56969:" | lolcat
echo -e "Host: 81/client-tcp.ovpn" | lolcat
echo -e "=============================" | lolcat
echo -e "  Config OpenVPN UDP 1945: " | lolcat
echo -e "Host: 81/client-udp.ovpn " | lolcat
echo -e "=============================" | lolcat
echo -e "  Config OpenVPN SSL 569:" | lolcat
echo -e "Host: 81/569client-ssl.ovpn" | lolcat
echo -e "=============================" | lolcat
